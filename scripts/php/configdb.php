...
if(isset($_POST['deletedb'])) {
    ...
    $sql = "DELETE FROM classcardinquiry";
    
    if(mysqli_query($con, $sql)) {
        echo '<p style="position:absolute; color:white; font-size:36px">Current database has been deleted</p>';
    } else {
        echo '<p style="position:absolute; color:white; font-size:36px">Error deleting database</p>';
    }
}
?>